...
public final class BrokenConcurrencyWithoutVolatile {
	/* volatile */ long l = 0L;
	...
	private void test(final boolean sleep, final int pass) throws InterruptedException {
		...
		final Thread t0 = new Thread() {
			...
			@Override
			public void run() {
				BrokenConcurrencyWithoutVolatile.this.l = 1L;
			}
		}; 
		t0.start(); // HB
		...
		assertEquals(format("Pass %d: ", pass), 1L, BrokenConcurrencyWithoutVolatile.this.l);
